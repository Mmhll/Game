...
class SecondMinusFragment : Activity() {
    private lateinit var firstButton : Button
    private lateinit var secondButton : Button
    private lateinit var preferences: SharedPreferences
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.fragment_second_minus)
        firstButton = findViewById(R.id.first_answer_minus_2)
        secondButton = findViewById(R.id.second_answer_minus_2)
        ...
        firstButton.setOnClickListener {
            ...
            finishActivity(R.layout.fragment_minus)
