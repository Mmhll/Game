package com.mhl.myapplication.ui.plus.exercise
...
class SecondPlusFragment : Activity() {
    private lateinit var firstButton : Button
    private lateinit var secondButton : Button
    private lateinit var preferences: SharedPreferences
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.fragment_second_plus)
        firstButton = findViewById(R.id.first_answer_plus_2)
        secondButton = findViewById(R.id.second_answer_plus_2)
